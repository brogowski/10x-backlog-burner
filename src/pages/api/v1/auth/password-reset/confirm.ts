...
import { AuthServiceError, confirmPasswordReset } from "../../../../../lib/services/auth.service";
...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  try {
    ...
    if (error instanceof ZodError) {
      ...
      const message = error.issues[0]?.message ?? "Password is required for reset.";
    ...
    return jsonError(400, "validation_error", "Password is required for reset.");
  }
