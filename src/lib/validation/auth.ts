...
export const parseResetRequestPayload = (
  payload: unknown,
): ResetRequestPayload => resetRequestSchema.parse(payload)

export const parseResetConfirmPayload = (
  payload: unknown,
): ResetConfirmPayload => resetConfirmSchema.parse(payload)
