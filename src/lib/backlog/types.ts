...
export interface BacklogGameItemVM {
  steamAppId: number;
  title: string;
...
export interface BacklogPageVM {
...
export interface FetchBacklogQuery {
  status: "backlog";
  page: number;
  pageSize: number;
...
export interface AddToInProgressRequest {
  status: "in_progress";
...
export const mapUserGamesToBacklogPage = (dto: UserGamesListDTO, existing?: BacklogPageVM): BacklogPageVM => {
